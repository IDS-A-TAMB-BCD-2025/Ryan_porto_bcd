...
CREATE TABLE IF NOT EXISTS PRODUTOS(
	...
	CODICO_BARRAS VARCHAR(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS FUNCIONARIO(
    ...
    NOME VARCHAR(255) NOT NULL,
    FK_SUPERMERCADO_CNPJ VARCHAR(255) NOT NULL,
...
-- ALTERAR TABELA CONSUMIDOR, ADICIONAR DATA_NACIMETO
ALTER TABLE CONSUMIDOR
ADD COLUMN DATA_NACIMENTO DATE NOT NULL;

-- ALTERA TABELA SUPERMERCADO, MUDAR COLUNA TELEFONE
ALTER TABLE SUPERMERCADO
CHANGE COLUMN TELEFONE TELEFONE_SUPERMERCADO VARCHAR(15);


-- ALTERAR TABELA SUPER MERCADO, MODIFICAR COLUNA LOGRADOURO
ALTER TABLE SUPERMERCADO 
MODIFY COLUMN LOGRADOURO VARCHAR(500);

-- ALTERAR TABELA CONSUMIDOR, APAGAR COLUNO EMAIL
ALTER TABLE CONSUMIDOR
DROP COLUMN EMAIL;
